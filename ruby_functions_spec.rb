...
def test_volume_of_a_sphere()
  length_of_radius = 1
  volume_of_a_sphere = ( 4.00/3.00 ) * 3.14 * length_of_radius ** 3.00
  # return test_volume_of_a_sphere.round(2)
  assert_equal( 4.19, volume_of_a_sphere.round(2) )
end
...
def test_fahrenheit_to_celsius()
  ...
  fahrenheit_to_celsius = temp_in_fahrenheit * 1.8 + 32
  assert_equal( 32, fahrenheit_to_celsius)
end
